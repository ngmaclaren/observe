...
## )
                                        # adding two more
networks <- c("proximity_weighted", "usair")
...
for(network in networks) {
    ...
    par(mar = c(5, 5, 1, 1), pty = "s")
                                        # Each of these blocks is commented b/c we don't show the individual lines
                                        # with the bigger networks
    ## matplot(
    ...
    if(save_plots) dev.off()
                                        ...
                                        # DO NOT REMOVE!
                                        # Below here:
                                        # code for comparing performance of degree-preserving vs. opt/rand
